...
//      Tpbuilder.setBolt("SplitterBoltwfatdt", new Yunguan_G4JK_BasicATDTSplitter(),1).shuffleGrouping("Spoutwfatdt");
        ...
        Tpbuilder.setBolt("HmapAccBoltwfg4", new Yunguan_G4JK_HmapAccToRedis(),18).shuffleGrouping("SplitterBoltwf4g");
        ...
        Tpbuilder.setBolt("SJJS208Bolt88wfg4", new Yunguan_G4JK_SJJS208_88ToRedis(),9).shuffleGrouping("SJJS093Bolt93wfg4");
        Tpbuilder.setBolt("ZhToCountBoltwfg4", new Yunguan_G4JK_ZhWordsToCountBolt(),9).shuffleGrouping("SplitterBoltwf4g");
        Tpbuilder.setBolt("ZhCountBoltwfg4", new Yunguan_G4JK_ZhWordsCountToRedis(),9).shuffleGrouping("ZhToCountBoltwfg4");
        /*拓扑执行*/
        //Configuration
