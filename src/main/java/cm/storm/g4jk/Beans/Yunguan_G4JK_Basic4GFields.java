...
public class Yunguan_G4JK_Basic4GFields {
		...
		public static final String EVENT_TYPE="event_type";						//空字段，事件类型（目前无法区分get/post流程）
		...
		public static final String GMCC_BUS_IND="gmcc_bus_ind";			//空字段，是否为自有业务
		public static final String PHONE_BRAND="phone_brand";				//空字段，手机品牌
		public static final String PHONE_TYPE="phone_type";					//空字段，手机型号
