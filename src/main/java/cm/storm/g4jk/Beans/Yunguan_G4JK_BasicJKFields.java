...
/*
 * 对应家宽网分数据的字段属性名称，标记流bolt发射流的字段名称，一共16个，目前有用的有14个
 */
public class Yunguan_G4JK_BasicJKFields {
	...
	public static final String PROTOCOL_TYPE="protocol_type";		//空字段，业务使用协议（get或post），流中默认空值代表HTTP协议，此处设置为1
	...
	public static final String SRC_PORT="src_port";							//空字段，源端口默认为空
